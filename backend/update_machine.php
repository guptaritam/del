<?php session_start();
    ...
    $lata = get_data_id_data("machine", "id", $id);
   // print_r($lata);
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <h5 class="mb-4">Basic Informations</h5>
                             <form action="update_machine_handle.php" method="POST" onsubmit="return validate_form();" id="myform">

                                <div class="col-lg-8">
                                <div class="form-group">
                                    <label for="machine_name" style="font-weight: bold;">Machine Name</label>
                                    <input type="text" class="form-control" name="machine_name" id="machine_name" placeholder="Enter Name" value="<?php echo $lata['name']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="quantity" id="quantity" placeholder="Enter Quantity" value="<?php echo $lata['quantity']; ?>">
                                </div>
                            </div>
                             ...
                             <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="machine_amount" id="machine_amount" placeholder="Enter Amount" value="<?php echo $lata['amount']; ?>">
                                </div>
                            </div>
