<?php session_start();
    ...
    $lata = get_data_id_data("expense_type", "id", $id);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-lg-6">
              <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="update_expensetype_handle.php" method="POST" onsubmit="return validate_form();" id="myform">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="expense_type" id="expense_type" placeholder="Enter Type" value="<?php echo $lata['expensetype_name'];?>">
                                </div></div>
