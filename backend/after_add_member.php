...
<body>
  <p><a href="view_members.php" class="btn btn-info hidden-print" style="margin-left: 15px; color:grey; text-decoration: none; background-color: #f2f2f2;">Back</a></p>
 
 <?php 
        $data = get_data_id_data("member", "id", $id);                
          echo'</br>
