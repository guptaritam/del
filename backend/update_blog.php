<?php session_start();
    ...
    $lata = get_data_id_data("blog", "id", $id);
   // print_r($lata);
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <form action="update_blog_handle.php" method="POST" enctype="multipart/form-data" id="myform">
                      <div class="card-box items">
                        ...
                        <div style="padding:10px">
                          <label>Title</label>
                          <input type="text" name="blog_title" placeholder="Enter Title" class="form-control" value="<?php echo $lata['title']; ?>" required="">
                        </div>

                        <div style="padding:10px">
                         <label>Please Enter Description</label>
                        <textarea id="blog_desc" name="blog_desc" class="form-control"><?php echo $lata['desc']; ?></textarea>
                        </div>

                        <div style="padding:10px">
                          <label>Tags</label>
                          <input type="text" name="blog_tags" placeholder="Enter Tags" class="form-control" value="<?php echo $lata['tags']; ?>" required="">
                        </div>

                         <!-- <div style="padding:10px">
                          <label>Attach Images</label>
                          <input type="file" name="file" placeholder="Attach Image" class="form-control" value="<?php  ?>" required="">
                        </div> -->
