<?php
   ...
   //$aata = get_data_id_data("member", "id", $id2);
   $date = $lata['date'];
	       ...
	       <div class="card-body">
			 	<h3>Payment Done Details </h3><hr/>
                    ...
                    <table class="table table-striped">
                     ...
                     <?php 
                        $i=1;
                        $value = get_data_col("payment", "member_id",  $lata['member_id']);
                        
                        foreach ($value as $key => $value) {
                          $btn = '<a target="_blank" title="click Here to View Details" href="payment_details.php?8d1d4357e1e1c6b3e4ea6df4ff01fede='.base64_encode($value['id']).'" class="btn btn-sm btn-primary">Details</a>';
