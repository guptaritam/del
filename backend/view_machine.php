...
<body id="app-container" class="menu-default show-spinner">
    ...
    <main>
        <div class="container-fluid">
             <div class="row">
                <div class="col-12">
                    <h1>View Machine <a href="add_machine.php" class="badge badge-success badge-sm" style="font-size: 10px;">Add New</a></h1>                   
                                                        ...
                                                        <td>
                                                            <div class="btn-group mb-1">
                                                                ...
                                                                <div class="dropdown-menu" x-placement="top-start" style="position: absolute; transform: translate3d(0px, -106px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                    <a class="dropdown-item" href="update_machine.php?8d1d4357e1e1c6b3e4ea6df4ff01fede='.base64_encode($value['id']).'">Update</a>
                                                                    <a class="dropdown-item" href="delete_machine.php?8d1d4357e1e1c6b3e4ea6df4ff01fede='.base64_encode($value['id']).'" onclick="return confirm(\'Are You Sure You want to Delete This?\')">Delete</a>
