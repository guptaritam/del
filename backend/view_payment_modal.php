...
<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>
 ...
 <?php 
    try {
          $stmt = $pdo->prepare('SELECT * FROM `payment` WHERE `id`="'.$_REQUEST['id'].'" ');
      ...
      foreach($user as $key=>$value){   
        $data = get_data_id_data("member", "member_id", $value['member_id']);                
          echo'</br><button class="btn btn-primary hidden-print" onclick="myFunction()"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print</button>
                ...
                <tr>
                  ...
                  <td style="padding:10px;text-align:right">
                     ...
                     <b>Age: </b> '.$data['age'].'</br> 
                     <b>Validity From - To: </b> '.$data['validity_from'].' <b>To</b> '.$data['validity_to'].'</br> 
                     <b>Date : </b> '.$data['date'].'
                  </td>
                </tr>
              </table>';
